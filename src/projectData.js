export const projects = {
  1: {
    title: `Where's Waldo Variation`,
    mainPic: 'https://i.imgur.com/QvLXhNB.png',
    images: [
      ...
      'https://bit.ly/3zecQlV',
      'https://bit.ly/3MJpWNa',
      'https://bit.ly/3VCAdis',
    ],
    technologies: ['Firebase', 'React', 'HTML', 'CSS', 'Javascript'],
    live: 'https://0xbn.github.io/hidden-objects-game/',
    source: 'https://github.com/0xBN/hidden-objects-game',
    description: 'Game where the user finds objects on screen.',
    challenges:
      'Tagged location of object same on different client window sizes, first experience using Firebase to write and save to docs for leaderboard tracking',
  },
  2: {
    title: `Where's Waldo Variation`,
    mainPic: 'https://i.imgur.com/QvLXhNB.png',
